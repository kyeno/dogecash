...
public:
    CMainParams()
    {
        ...
        consensus.nTime_EnforceNewSporkKey = 1600005947;   //!> December 21, 2020 01:00:00 AM GMT
        consensus.nTime_RejectOldSporkKey = 1600005947;    //!> March 1, 2021 01:00:00 AM GMT
        ...
        consensus.nPivxBadBlockBits = 488380309;    // Skip nBit validation of Block 259201 per PR #915
        ...
        consensus.vUpgrades[Consensus::UPGRADE_V5_2].nActivationHeight          = 1380000;
        consensus.vUpgrades[Consensus::UPGRADE_V5_3].nActivationHeight          = 1380020;
        ...
        vSeeds.emplace_back("x9.seeds.dogec.io", true);    // Secondary DNS Seeder from Liquid369
        ...
        base58Prefixes[EXT_COIN_TYPE] = {0x80, 0x00, 0x00, 0x81};
        ...
        bech32HRPs[SAPLING_INCOMING_VIEWING_KEY] = "divks";
