...
#include "qt/dogec/forms/ui_masternodeswidget.h"

#include "qt/dogec/qtutils.h"
#include "qt/dogec/mnrow.h"
#include "qt/dogec/mninfodialog.h"
#include "qt/dogec/masternodewizarddialog.h"

#include "clientmodel.h"
#include "guiutil.h"
#include "qt/dogec/mnmodel.h"
#include "qt/dogec/optionbutton.h"
...
void MasterNodesWidget::onCreateMNClicked()
{
    ...
    if (walletModel->getBalance() <= mnCollateralAmount) {
        inform(tr("Not enough balance to create a masternode, %1 required.")
            .arg(GUIUtil::formatBalance(mnCollateralAmount, BitcoinUnits::DOGEC)));
        return;
    }
    showHideOp(true);
