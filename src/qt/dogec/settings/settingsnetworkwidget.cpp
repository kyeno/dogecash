...
#include "qt/dogec/settings/settingsnetworkwidget.h"
#include "qt/dogec/settings/forms/ui_settingsnetworkwidget.h"
#include "optionsmodel.h"
#include "qt/dogec/qtutils.h"

SettingsNetworkWidget::SettingsNetworkWidget(DogeCashGUI* _window, QWidget *parent) :
